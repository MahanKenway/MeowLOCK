...
export default function DataHubWidget({
  ...
  const handleExportFile = () => {
    try {
      ...
      setErrorMsg("Error exporting data: " + err.message);
    }
  };
  ...
  const handleCopyCode = async () => {
    try {
      ...
      setErrorMsg("Error copying code: " + err.message);
    }
  };
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        >
          ...
          <div className="text-right">
            <span className="block text-[10px] font-bold">Download Backup File</span>
      ...
      <div className="space-y-3 pt-3 border-t border-white/5">
        ...
        >
          ...
          <div className="text-[10px] font-medium text-gray-300">
            Drag and drop or select <span className="font-mono text-purple-400">.json</span> backup file here
          </div>
        ...
        <div className="space-y-1.5">
          <label className="block text-[9px] text-gray-400">Or paste the transfer code in the box below:</label>
        ...
        {showConfirmReset ? (
          <div className="bg-rose-950/20 border border-rose-500/20 rounded-xl p-2.5 space-y-2">
            <p className="text-[9px] text-rose-200 leading-normal">
              Are you sure? All your data, profiles, tasks, and settings will be permanently deleted.
